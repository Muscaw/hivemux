...
class TestHoneyCombSession:
  ...
  @pytest.mark.parametrize(
    "session_name, tmux_session_name", [("comb__dot", "comb__dot"), ("comb_project_name", "comb_project_name")]
  )
  def test_from_session_name(self, session_name: str, tmux_session_name: str) -> None:
